...
public class PostDumpFlow {
    private static final String PROJECT_ID = "around-330703";
...
/*
mvn compile exec:java -Dexec.mainClass=com.around.PostDumpFlow -Dexec.args=" --project=around-330703 --stagingLocation=gs://dataflowaround-330703/staging/ --tempLocation=gs://dataflowaround-330703/output --runner=DataflowPipelineRunner --jobName=dataflowintro"

mvn compile exec:java \
    -Dexec.mainClass=com.around.PostDumpFlow \
